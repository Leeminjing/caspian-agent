...
常量：
    ...
    REAL_ROOT: 真实路径根模板 ".focus/users/{user_id}/threads/{thread_id}/user-data"
...
示例:
    ...
    → ".focus/users/uuid-xxx/threads/abc123/user-data/workspace/script.py"
    ...
    → ".focus/users/u-1/skills/custom/my-skill/SKILL.md" 的绝对路径
...
REAL_ROOT = ".focus/users/{user_id}/threads/{thread_id}/user-data"
...
def resolve_skill_path(vpath: str, user_id: str) -> str:
    ...
    示例:
        ...
        resolve_skill_path("/mnt/skills/custom/my-skill/SKILL.md", user_id="u-1")
        → "<cwd>/.focus/users/u-1/skills/custom/my-skill/SKILL.md"
    """
