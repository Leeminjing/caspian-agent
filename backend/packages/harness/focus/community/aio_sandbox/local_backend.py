...
示例:
    from focus.community.aio_sandbox.local_backend import pull_image, create_container, start_container, health_check

    pull_image("ghcr.io/agent-infra/sandbox:latest")
    cid = create_container(image="...", port=8080, mounts=[], environment={},
                           container_name="focus-sandbox-...",
                           user_data_root=".focus/users/.../user-data",
