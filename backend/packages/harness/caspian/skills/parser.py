...
示例:
    ...
    from caspian.skills.types import SkillCategory
...
from caspian.skills.types import Skill, SkillCategory
from caspian.skills.validation import _validate_skill_frontmatter
