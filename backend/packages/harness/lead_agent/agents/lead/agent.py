...
def _discover_and_build_catalog(
    ...
    """
    from lead_agent.sandbox.path_utils import SKILLS_CUSTOM_REAL_ROOT, SKILLS_PUBLIC_REAL_ROOT
    from lead_agent.skills.catalog import SkillCatalog
    from lead_agent.skills.parser import parse_skill_file
    from lead_agent.skills.types import SKILL_MD_FILE, SkillCategory
...
async def make_lead_agent(
    ...
    from lead_agent.tools.builtins.describe_skill_tool import build_describe_skill_tool
