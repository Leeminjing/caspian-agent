...
示例:
    ...
    from lead_agent.skills.types import SkillCategory
...
from lead_agent.skills.types import Skill, SkillCategory
from lead_agent.skills.validation import _validate_skill_frontmatter
