...
class AioSandboxProvider:
    ...
    def _create_container(self, user_id: str, thread_id: str, sandbox_id: str, record: _ContainerRecord) -> None:
        from lead_agent.community.aio_sandbox.local_backend import (
        ...
        cid = create_container(
            ...
            skills_path=os.path.abspath(".lead_agent/skills"),
        )
    ...
    def get(self, sandbox_id: str) -> Sandbox:
        ...
        if record.sandbox is None:
            from lead_agent.community.aio_sandbox.aio_sandbox import AioSandbox
