...
示例:
    from lead_agent.community.aio_sandbox.local_backend import pull_image, create_container, start_container, health_check
    ...
    cid = create_container(image="...", port=8080, mounts=[], environment={},
                           ...
                           user_data_root=".lead_agent/users/.../user-data",
