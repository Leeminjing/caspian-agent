...
Source: https://github.com/reactjs/react.dev/blob/main/src/content/reference/react/index.md

### React Reference Overview

Source: https://github.com/reactjs/react.dev/blob/main/src/content/reference/react/index.md

Top-level index categorizing all React APIs into functional subsections: React (Hooks, Components, APIs, Directives), React DOM (Hooks, Components, APIs, Client APIs, Server APIs, Static APIs), React Compiler, ESLint Plugin, Rules of React, and Legacy APIs.
